      ...
      <div class="modal-body">
        <div class="form-group">
          ...
          <div class="form-group">
           ...
           class="form-control" :class="{'is-invalid': form.errors.has('Date of reunion')}">
                <has-error :form="form" field="datereunion"></has-error>
          </div>
          <div class="form-group">
            <input type="file" @change="updateFile" name="ata" placeholder="Meeting Minutes"
            class="form-control" :class="{'is-invalid': form.errors.has('Meeting Minutesn')}">
